        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative mt-8 md:mt-0 flex-1 h-[350px] md:h-full">
              <div className="absolute -bottom-12 md:-bottom-24 -right-4 md:right-0 w-[110%] md:w-full h-full">
                <Image 
                  src="/login_Ui.png" 
                  alt="Login Interface"
                  fill
          ...
          >
            <div className="max-w-[380px] z-10">
              <h4 className="text-white font-semibold text-[20px] lg:text-[22px] mb-4">Built for Real Privacy</h4>
            ...
            <div className="relative flex-1 w-full h-full mt-6">
              <div className="absolute -bottom-10 -right-8 md:-right-16 w-[110%] md:w-[120%] h-[110%]">
                <Image 
                  src="/intro_Ui.png" 
                  alt="Chat Interface" 
                  fill 
